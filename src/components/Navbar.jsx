    ...
    <div className="navbar">
      ...
      <div className="profile_bag">
        <div className="px-[10px]">
          ...
          <div>
            <Link to="/profile" className="font-bold text-[14px]">
              Profile
            </Link>
          </div>
        </div>
        <div className="px-[10px]">
          ...
          <div>
            <Link to="/wishlist" className="font-bold text-[14px]">
              Wishlist
            </Link>
          </div>
        </div>
        ...
        <div className="px-[10px]">
          ...
          <div>
            <Link to="/bag" className="font-bold text-[14px]">
              Bag
            </Link>
          </div>
        </div>
